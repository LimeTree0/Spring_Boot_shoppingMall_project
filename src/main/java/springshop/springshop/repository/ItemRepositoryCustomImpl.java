...
import springshop.springshop.dto.QMainItemDto;
import springshop.springshop.entity.Item;
import springshop.springshop.entity.QItem;
import springshop.springshop.entity.QItemImg;
...
public class ItemRepositoryCustomImpl implements ItemRepositoryCustom {
    ...
    @Override
    public Page<Item> getAdminItemlistPage(ItemSearchDto itemSearchDto, Pageable pageable) {
        ...
        return new PageImpl<>(results, pageable, total.fetchOne());
    ...
    public Page<MainItemDto> getMainItemPage(ItemSearchDto itemSearchDto, Pageable pageable) {
        ...
        log.info("total: {}", total.fetchOne());
        log.info("result: {}", result.size());

        return new PageImpl<>(result, pageable, total.fetchOne());
    }
}
